...
export const createConferenceCompanySchema = z.object({
  ...
  productFit: z.boolean().default(false),
  expansionFit: z.boolean().default(false),
...
export const updateConferenceCompanySchema = z.object({
  ...
  productFit: z.boolean().optional(),
  expansionFit: z.boolean().optional(),
...
export const conferenceCompanyImportMappingSchema = z.object({
  ...
  sector: z.string().optional(),
  productFit: z.string().optional(),
  expansionFit: z.string().optional(),
  budgetFit: z.string().optional(),
