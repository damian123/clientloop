...
- Playwright browser coverage for permission-aware custom field, toolbar create, timeline, task queue, and Data view UI states plus timeline create, correction, task completion, and CSV import/export workflows.
