...
- Follow-up task creation, URL-backed task queue filters, copyable workspace links, and inline task corrections from record detail timelines and the main task queue.
