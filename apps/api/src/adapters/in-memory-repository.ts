...
export class InMemoryCRMRepository implements CRMRepository {
  ...
  async createConferenceCompany(
    ...
    const company: ConferenceCompany = {
      ...
      expansionFit: input.expansionFit,
  ...
  async updateConferenceCompany(input: {
    ...
    const updated: ConferenceCompany = {
      ...
      productFit: input.body.productFit ?? current.productFit,
      expansionFit:
        input.body.expansionFit ?? current.expansionFit,
      budgetFit: input.body.budgetFit ?? current.budgetFit,
